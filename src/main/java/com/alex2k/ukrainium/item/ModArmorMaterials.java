...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    UKRAINIUM("ukrainium", 45, new int[]{4, 7, 9, 4}, 20, SoundEvents.ARMOR_EQUIP_NETHERITE, 4.0F, 0.25F, () -> {
        return Ingredient.of(ModItems.UKRAINIUM_INGOT.get());
    });
    ...
    public String getName() {
        return Ukrainium.MOD_ID + ":" + this.name;
    }
